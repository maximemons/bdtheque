	...
	asideMenu.innerHTML = `
        ...
        <ul class="nav-links">
            ...
            <li><a href="#"><i class="fas fa-folder-open"></i>Ma BDtheque</a>
                <ul>
                	<li><a href="https://maximemons.github.io/bdtheque/bds/bds.html"><i class="fas fa-book"></i>Mes BDs</a></li>
                    <li><a href="https://maximemons.github.io/bdtheque/collections/collections.html"><i class="fas fa-folder"></i>Mes Collections</a></li>
                    <li><a href="https://maximemons.github.io/bdtheque/editeurs/editeurs.html"><i class="fas fa-pencil"></i>Mes Editeurs</a></li>
                </ul>
            </li>
